...
.PHONY: test tune ablation sweep agentic fidelity figures inspector docx artifact site ui api all clean
...
all: test tune ablation sweep agentic fidelity figures inspector docx artifact site ui
